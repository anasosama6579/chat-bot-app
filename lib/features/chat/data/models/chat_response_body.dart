...
class UsageMetadata{
  ...
  UsageMetadata(this.promptTokenCount, this.candidatesTokenCount,
      this.totalTokenCount, this.promptTokensDetails, this.thoughtsTokenCount);
...
class PromptTokenDetail {
  ...
  factory PromptTokenDetail.fromJson(Map<String,dynamic> json) => _$PromptTokenDetailFromJson(json);
